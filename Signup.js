        ...
        return (
            <div className='div-login'>
                ...
                <div id="logo">
                    ...
                    {/* <h2></h2>   */}
                                <input onChange={this.handleChange} type="email" id="emailid" name="emailId" placeholder="Enter your email" required /><br />
                                {/* <p id = "anveshakkati"></p> */}
                                <input onChange={this.handleChange} type="text" id="uname" name="userName" placeholder="Enter Name" required /><br />
                                <input onChange={this.handleChange} type="password" id="pswd" name="password" placeholder="Enter Password" required minLength="8" /><br />
                                <input onChange={this.handleChange} type="text"pattern="[0-9]*" id="contact" name="mobileNumber" placeholder="Enter Mobile number" required /><br />
                                <input onChange={this.handleChange} type="date" id="dob" neme="date" placeholder="Enter Date of birth" required /><br />
