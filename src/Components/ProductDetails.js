...
export default function ProductDetails(props) {
  ...
  const handleSubmit = (e) =>{
      ...
      const response =  axios.post(
          'http://localhost:8080/api/PinRegistry/getPin',user)
      ...
      // function Foo(props){
      //  const data = axios.get('http://localhost:8080/PinRegistry/getPin',user)
      //   return(
      //     <>
      //     <h1>abcd</h1>
      //       {console.log(data)}
...
useEffect(() => {
  ...
  function  handleAddToCart(data) {
    ...
    addToast(data.productname+" has been added to cart successfully", { appearance: 'success', autoDismiss: true, })
      ...
      <div className="row">
        ...
        <div className="col-lg-5">
          ...
          <form
                    ...
                    <button type="submit" onClick={handleSubmit}id="check" name="check">Check</button>
