        ...
        return(
            <div className='div-login'>
                <div id="logo">
                    ...
                    <input onChange={({ target }) => setEmailId(target.value)} type="email" id="emailid" name="EmailId" placeholder="Enter your email" required="required" data-validation-required-message="Please enter your emailId"/><br/>
                    <input onChange={({ target }) => setPassword(target.value)} type="password" id="pwd" name="Password" placeholder="Enter Password" required="required" data-validation-required-message="Please enter your password"/><br/>
